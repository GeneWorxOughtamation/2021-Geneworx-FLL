...
SA = [100, 250, 50, 300, 150, 50, 200, 400, 50, 300, 50]
...
while robot.distance() <= I2mm(10):
    D = mm2I( robot.distance() )
    D = math.trunc(D)
    print("D = ", D, mm2I( robot.distance() ) )
    left_motor.run(SA [D])
    right_motor.run(SA [D])
...
#gyrom(I2mm(9.25), -30, 100)             #Turn to the right by 30 degrees, go straight 7.25 inches

#Rgear(200, 150)                        # The right Medim motor will rotate 150 degrees to the right depositing
                                       # the truck and the atatchment.  (x Points)

#gyrom(I2mm(2), -30, 100)                # Go back five inches straight
...
#gyrom(I2mm(7), 0, 150)                 # Robot will move 7 inches foreward
